CHEM 2000 Lecture: November 13, 2025
...
![Standard Deviation Diagram](https://github.com/ekachem/TEST/blob/master/gauss_dist.png)
...
![Eq2a](https://latex.codecogs.com/svg.image?x_{1},x_{2},\cdots,x_{N_A}).
...
- \(X\) lies within the infinitesimal range ![Eq10](https://latex.codecogs.com/svg.image?x\le{X}\le{x+dx}) and  
- \(Y\) lies within ![Eq10](https://latex.codecogs.com/svg.image?y\le{Y}\le{y+dy}).
...
- If ![Eq1](https://latex.codecogs.com/svg.image?\rho_{xy}>0): X and Y are positively correlated when ![Eq1](https://latex.codecogs.com/svg.image?X>\langle{X}\rangle,\quad{Y}>\langle{Y}\rangle).  
- If ![Eq1](https://latex.codecogs.com/svg.image?\rho_{xy}<0): X and Y are negatively correlated when ![Eq1](https://latex.codecogs.com/svg.image?X>\langle{X}\rangle,\quad{Y}<\langle{Y}\rangle), or vice versa.
