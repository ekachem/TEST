...
- If ![Eq1](https://latex.codecogs.com/svg.image?\rho_{xy}>0): X and Y are positively correlated when ![Eq1](https://latex.codecogs.com/svg.image?X>\langle{X}\rangle,%20{Y}>\langle{Y}\rangle).  
- If ![Eq1](https://latex.codecogs.com/svg.image?\rho_{xy}<0): X and Y are negatively correlated when ![Eq1](https://latex.codecogs.com/svg.image?X>\langle{X}\rangle,%20{Y}<\langle{Y}\rangle), or vice versa.
